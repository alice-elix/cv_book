 ...
 */
final class Version20200617020944 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE projets CHANGE structure_name structure_name VARCHAR(255) DEFAULT NULL, CHANGE header_structure header_structure VARCHAR(255) DEFAULT NULL, CHANGE catchy_sentence catchy_sentence VARCHAR(255) DEFAULT NULL, CHANGE presentation_pict presentation_pict VARCHAR(255) DEFAULT NULL, CHANGE context_pict context_pict VARCHAR(255) DEFAULT NULL, CHANGE framework_name framework_name VARCHAR(255) DEFAULT NULL');
    }
