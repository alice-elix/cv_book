 ...
 */
final class Version20200620183521 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mails CHANGE name name VARCHAR(255) NOT NULL, CHANGE tel tel VARCHAR(255) DEFAULT NULL, CHANGE object object VARCHAR(255) DEFAULT NULL, CHANGE part part VARCHAR(255) DEFAULT NULL');
